...
<h3 align="center">A single-click solution for a wholesome, aesthetic Windows Terminal setup.</h3>
...
3. **Restart Windows Terminal** to see the changes.
...
- **Terminal Settings**: Automatically updates `%LOCALAPPDATA%\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState\settings.json`.
